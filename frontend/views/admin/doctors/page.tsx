...
import { TableSkeleton, PremiumEmptyState } from '@/components/common/PremiumLoaders';
      ...
      <div className="space-y-8 pb-20">
        ...
        {isLoading ? (
          ...
          <PremiumEmptyState 
            ...
            description="Add clinical consultant profiles to schedule appointments and queue tokens."
            actionButton={
              <Link 
                href="/admin/doctors/add"
                className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white font-bold rounded-xl text-sm hover:bg-black transition-all shadow-lg uppercase tracking-widest"
              >
                + Add First Doctor
              </Link>
            }
