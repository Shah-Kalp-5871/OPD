...
export default function AddTestView() {
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-6 pb-20">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900">Add New Lab Test</h1>
            <p className="text-xs font-bold text-slate-400 tracking-widest uppercase mt-1">Lab Master / Tests / Add</p>
          </div>
        </div>
