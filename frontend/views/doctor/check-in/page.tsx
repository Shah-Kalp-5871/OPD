  ...
  return (
    <DoctorLayout>
      <div className="w-full px-4 md:px-6 py-4 font-sans">
                ...
                <div className="grid gap-2">
                    {searchResults.map(p => (
                        <div key={p.id} onClick={() => handleSelectPatient(p)} className="p-3 border border-slate-100 rounded-lg hover:border-sky-500 hover:bg-sky-50/30 cursor-pointer transition-all flex items-center justify-between group">
                            ...
                            <div className="text-[#0d6282] opacity-0 group-hover:opacity-100 transition-opacity text-sm">Select &rarr;</div>
                        </div>
                    ))}
                </div>
            </div>
        ...
        {checkInResult && (
            <div className="mb-5 p-4 bg-sky-50 border border-sky-200 rounded-xl flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div>
                      <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2 flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-bold text-[#0d6282] bg-sky-50 px-2 py-0.5 rounded-full">{availableSlots.length} slots</span>
                      </label>
