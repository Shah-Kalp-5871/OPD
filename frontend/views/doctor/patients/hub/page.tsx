...
const PatientHubView = () => {
  ...
  const handleCaseChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    router.push(`/doctor/patients/${patientId}?caseId=${newCaseId}`, { scroll: false });
  };
    ...
    return (
      <DoctorLayout>
        <div className="flex flex-col items-center justify-center h-[60vh] gap-4 animate-in fade-in zoom-in duration-500">
           <div className="w-20 h-20 bg-sky-100 rounded-full flex items-center justify-center animate-pulse">
              <Lock className="w-10 h-10 text-[#0d6282]" />
           </div>
                       ...
                       <div className="flex items-center gap-4 bg-white px-4 py-2 rounded-2xl border border-slate-200 shadow-sm">
                         ...
                         <div className="relative">
                           <select
                             ...
                             className="appearance-none bg-transparent pl-2 pr-8 py-2 text-sm font-bold text-slate-700 uppercase tracking-wide outline-none cursor-pointer hover:text-[#0d6282] transition-colors"
                           >
