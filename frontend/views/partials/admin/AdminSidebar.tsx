...
const menuItems = [
  ...
  { label: 'Lab Master', icon: FlaskConical, href: ROUTES.admin.lab },
  { label: 'Procedure Master', icon: Stethoscope, href: ROUTES.admin.procedures },
  { label: 'Discounts', icon: Percent, href: ROUTES.ADMIN_DISCOUNTS },
  { label: 'Notifications', icon: Bell, href: ROUTES.ADMIN_NOTIFICATIONS },
  { label: 'Reports', icon: BarChart3, href: ROUTES.admin.reports },
  ...
  { label: 'Security Center', icon: Activity, href: ROUTES.admin.securityCommandCenter },
  { label: 'Settings', icon: Settings, href: ROUTES.admin.settings },
  { label: 'Support', icon: LifeBuoy, href: ROUTES.ADMIN_SUPPORT },
  { label: 'My Profile', icon: UserCircle, href: ROUTES.admin.profile },
