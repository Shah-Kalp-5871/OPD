      ...
      <div className="flex items-center gap-4">
        <div className="flex flex-col">
          <div className="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
             ...
             <span className="text-green-600">Dashboard – Today's Overview</span>
          </div>
          <div className="flex items-center gap-3 mt-1.5">
             <div className="flex items-center gap-1.5 px-2 py-0.5 bg-green-50 rounded text-[9px] font-bold text-green-600 uppercase tracking-widest">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative hidden lg:block">
           ...
           <input 
             ...
             className="pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-[10px] font-black uppercase tracking-widest outline-none focus:border-green-500 focus:bg-white transition-all w-48"
           />
        </div>

        {/* Notifications */}
        <button className="relative p-2.5 text-slate-400 hover:text-green-600 hover:bg-green-50 rounded-xl transition-all">
        ...
        <div className="relative">
          <button 
            ...
            className="flex items-center gap-3 pl-3 pr-2 py-1.5 border border-slate-200 rounded-xl hover:border-green-200 hover:bg-slate-50 transition-all group"
          >
          ...
          {showProfile && (
            <div className="absolute right-0 mt-3 w-56 bg-white border border-slate-100 rounded-2xl shadow-xl py-3 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
               ...
               <button className="w-full flex items-center gap-3 px-5 py-2.5 text-[10px] font-black text-slate-600 uppercase tracking-widest hover:bg-slate-50 hover:text-green-600 transition-all">
